        ...
        switch (subCom) {
            ...
            case "set_server": {
                ...
                if (!pat) {
                    return super.error(
                        interaction,
                        "Sorry, but you need to be subscribed through [Patreon](https://patreon.com/swgohbot) in order to select a server.",
                    );
                }
            ...
            default: {
                ...
                if (!pat || pat.amount_cents < 100) {
                    ...
                    const tiers = Object.keys(patreonInfo.tiers)
                        .map((t) => Number.parseInt(t, 10)) // Make sure they're numbers instead of strings
                    ...
                    fields.push({
                        ...
                        value: `>>> ${Object.keys(outObj)
                            .map((ben) => `**${ben}:** ${outObj[ben]}`)
                            .join("\n")}`,
                    });
                }
                break;
