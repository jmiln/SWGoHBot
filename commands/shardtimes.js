...
const momD = require('moment-duration-format');
...
exports.run = async (client, message, args, level) => {
    ...
    let [action, userID, timezone, ...flag] = args;
    ...
    if (action === 'add') {
		...
		sortedShardTimes = Object.keys(shardOut).sort((a, b) => momentTZ(a, 'HH:mm').diff(momentTZ(b, 'HH:mm')));
