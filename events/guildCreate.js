module.exports = (client, guild) => {
    ...
    guild.owner.send(`Thank you for adding this SWGoHBot! Before using me, please configure the Admin role by running the following command: \`${client.config.prefix}setconf adminRole <AdminRoleName>\`.\nThis will allow anyone with that Discord role to edit the bot's settings.\nAnd now you're all set to begin using SWGoHBot!`);
};
