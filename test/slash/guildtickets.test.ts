...
describe("GuildTickets", () => {
    ...
    it("should work without guild context (guildOnly: false)", () => {        const command = new GuildTickets();

        assert.strictEqual(command.commandData.guildOnly, false, "Expected guildOnly to be false");
    });

    it("should be enabled", () => {        const command = new GuildTickets();

        assert.strictEqual(command.commandData.enabled, true, "Expected command to be enabled");
    });

    it("should have correct command configuration", () => {        const command = new GuildTickets();
    ...
    it("should have set subcommand", () => {        const command = new GuildTickets();
    ...
    it("should have view subcommand", () => {        const command = new GuildTickets();
    ...
    it("should have channel option in set subcommand", () => {        const command = new GuildTickets();
    ...
    it("should have sortby option with choices in set subcommand", () => {        const command = new GuildTickets();
