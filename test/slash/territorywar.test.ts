...
describe("TerritoryWar", () => {
    ...
    it("should work without guild context (guildOnly: false)", () => {        const command = new TerritoryWar();

        assert.strictEqual(command.commandData.guildOnly, false, "Expected guildOnly to be false");
    });

    it("should be enabled", () => {        const command = new TerritoryWar();

        assert.strictEqual(command.commandData.enabled, true, "Expected command to be enabled");
    });

    it("should have correct command configuration", () => {        const command = new TerritoryWar();
    ...
    it("should have required allycode_1 option", () => {        const command = new TerritoryWar();
    ...
    it("should have required allycode_2 option", () => {        const command = new TerritoryWar();
    ...
    it("should compare guild rosters based on ally codes", () => {        const command = new TerritoryWar();
